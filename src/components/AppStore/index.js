...
class AppStore extends Component {
  state = {activeCategory: 'SOCIAL', searchInput: ''}
  ...
  render() {
    ...
    const queryList = appsList.filter(
      eachApp =>
        eachApp.category === activeCategory &&
    ...
    return (
      <div className="app-store">
        ...
        <ul className="apps-tab">
          {queryList.map(eachApp => {
